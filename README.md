...
Janvi Mahapadi
She handled the complete implementation of the project, including generating and loading the dataset, performing data preprocessing such as missing value handling, outlier removal, and feature scaling, building and evaluating regression models, integrating advanced regression techniques along with meaningful visualizations, and compiling the final Google Colab notebook and project documentation.

Devendra Ghawat
Assisted with outlier detection using the Z-score method and Contributed to understanding the impact of outlier removal on regression performance

Kshitija Satpute
Worked on feature selection techniques and Helped analyze the impact of feature selection on model performance
